...
import { query, exports } from '../../services/inventory/reportDiff';
...
export default {
  ...
  effects: {
    ...
    * reload(action, { put, select }) {
      const pagination = yield select(state => state.reportDiff.pagination);
      const storeId = yield select(state => state.reportDiff.storeId);
